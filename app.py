...
from agents.strategy_agent import strategy_analysis
...
st.title("Key South Lab - Team Epsilon - International Finance Corporation - AI Credit Scoring SaaS Platform - (version α, nombre d’itérations réduit de 90 % pour des tests rapides sur Streamlit)")
...
if uploaded_file:
    ...
    if run_ai:
        ...
        if st.button("Lancer analyse IA"):
            ...
            shap_row = shap_values[index].values.tolist()
